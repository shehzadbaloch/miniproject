...
class IncludesControllerTest < ActionController::TestCase
  ...
  test "should create include" do
    assert_difference('Include.count') do
      post :create, include: { order_id: @include.order_id, product_id: @include.product_id, quality: @include.quality }
    end
  ...
  test "should update include" do
    patch :update, id: @include, include: { order_id: @include.order_id, product_id: @include.product_id, quality: @include.quality }
    assert_redirected_to include_path(assigns(:include))
  end
